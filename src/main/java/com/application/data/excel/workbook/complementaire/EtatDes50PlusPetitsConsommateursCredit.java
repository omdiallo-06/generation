...
public class EtatDes50PlusPetitsConsommateursCredit extends MetaSheet {
	protected static final Logger log = LoggerFactory.getLogger(EtatDes50PlusPetitsConsommateursCredit.class);
	
	public EtatDes50PlusPetitsConsommateursCredit(Sheet sheetMasqueSaisie,Sheet sheetSics){
		super(sheetMasqueSaisie, sheetSics);
	}
	
	public EtatDes50PlusPetitsConsommateursCredit(Sheet sheetMasqueSaisie,Sheet sheetSics,String nomSfd,String moisArrete){
