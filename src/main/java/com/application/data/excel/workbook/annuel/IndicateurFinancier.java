...
public class IndicateurFinancier extends MetaSheet{
	
	public IndicateurFinancier(Sheet sheetMasqueSaisie,XSSFSheet sheetEtatFinancier){
        	       ...
        	       for (Iterator<Cell> cellIt = row.cellIterator(); cellIt.hasNext();) {
	            	  	...
	            	  	if(cell.getColumnIndex()<10){
		            	  	if(cell!=null  &&(cell.getCellType()==Cell.CELL_TYPE_NUMERIC || (cell.getCellType()==Cell.CELL_TYPE_FORMULA))){
			  						copieCell(cell.getColumnIndex()+1, cell.getRowIndex(), cell);
			  				}
	            	  	}
	               }
	           }
