...
public class ConditionsDebitricesEtCreditrices extends MetaSheet {
	protected static final Logger log = LoggerFactory.getLogger(ConditionsDebitricesEtCreditrices.class);
	
	
	public ConditionsDebitricesEtCreditrices(Sheet sheetMasqueSaisie,Sheet sheetSics){
		super(sheetMasqueSaisie, sheetSics);
	}
	public ConditionsDebitricesEtCreditrices(Sheet sheetMasqueSaisie,Sheet sheetSics,String nomSfd,String moisArrete){
